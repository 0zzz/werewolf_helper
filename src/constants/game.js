...
export const ROLE = {
    ...
    PRETTY_WEREWOLVED: new Role({
        ...
        icon: require('../icons/pretty_wolf.svg'),
    ...
    VILLAGERS: new Role({
        ...
        key: 'VILLAGERS',
        icon: require('../icons/village.svg'),
